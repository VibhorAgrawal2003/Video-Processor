...
class VideoProcessor(QWidget):
    def __init__(self):
      ...
      self.saturation_slider.setValue(127)
      ...
      sat_layout.addWidget(QLabel('Grayscale Saturation Slider'))
    ...
    def process_frame(self):
      ...
      if ret:
        ...
        # Set grayscale saturation from saturation slider
        ...
        frame_gs = cv2.cvtColor(frame_hsv, cv2.COLOR_HSV2BGR)
        ...
        if self.mode == self.btn_label_modes[0]:
          ...
          qt_image = QImage(frame_gs.data, w, h, bytes_per_line, QImage.Format_RGB888)
